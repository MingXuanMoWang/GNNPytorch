...
font_path = './msyhl.ttc'  # 或者其他正确的字体路径
...
center_word, pos_words, neg_words = sample.__next__()  # 从迭代器中取出一批次样本
print(center_word[0], words[int(center_word[0])], [words[i] for i in pos_words[0].numpy()])
